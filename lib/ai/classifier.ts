...
const BUSINESS_KEYWORDS: Record<string, string[]> = {
  'retail': ['магазин', 'продаю', 'торговля', 'товары', 'продажа', 'продаж', 'продавать', 'shop', 'store', 'sell', 'диски', 'одежда', 'обувь', 'техника', 'электроника'],
  'services': ['услуги', 'сервис', 'service', 'ремонт', 'repair', 'консультации', 'помощь', 'клининг', 'уборка'],
  'food': ['кафе', 'ресторан', 'доставка еды', 'кухня', 'еда', 'food', 'cafe', 'restaurant', 'пекарня', 'кондитерская', 'пицца', 'суши', 'бар'],
  'beauty': ['салон', 'красота', 'маникюр', 'парикмахер', 'spa', 'beauty', 'косметика', 'визаж', 'барбер', 'брови', 'ресницы'],
  'health': ['клиника', 'медицина', 'врач', 'здоровье', 'clinic', 'medical', 'стоматолог', 'фитнес', 'gym', 'массаж', 'йога'],
  'education': ['школа', 'курсы', 'обучение', 'тренинг', 'репетитор', 'school', 'course', 'education', 'уроки', 'преподаю'],
  'tech': ['it', 'разработка', 'программирование', 'сайт', 'приложение', 'software', 'dev', 'digital', 'smm', 'маркетинг'],
  'creative': ['дизайн', 'фото', 'видео', 'студия', 'creative', 'design', 'photo', 'video', 'контент', 'съёмка', 'монтаж'],
  'realty': ['недвижимость', 'аренда', 'квартиры', 'риелтор', 'real estate', 'realty', 'rent', 'жильё', 'дома'],
  'auto': ['авто', 'автосервис', 'машины', 'шиномонтаж', 'car', 'auto', 'детейлинг', 'мойка', 'сто', 'автомойка'],
  'legal': ['юрист', 'адвокат', 'право', 'lawyer', 'legal', 'юридические', 'нотариус'],
  'finance': ['финансы', 'бухгалтер', 'инвестиции', 'кредит', 'finance', 'accounting', 'банк', 'страхование'],
  'travel': ['туризм', 'путешествия', 'отель', 'travel', 'tourism', 'hotel', 'турагентство', 'экскурсии', 'гид'],
  'entertainment': ['развлечения', 'event', 'праздник', 'мероприятие', 'entertainment', 'клуб', 'бар', 'квест', 'игры', 'аниматор'],
  'adult': ['adult', 'порно', 'эскорт', '18+', 'стриптиз', 'контент для взрослых', 'onlyfans', 'порностудия', 'вебкам', 'webcam'],
  'ecommerce': ['интернет-магазин', 'онлайн', 'маркетплейс', 'e-commerce', 'ecommerce', 'wildberries', 'ozon', 'avito', 'авито'],
  'manufacturing': ['производство', 'фабрика', 'завод', 'manufacturing', 'factory', 'цех', 'мастерская', 'изготовление'],
  'logistics': ['доставка', 'логистика', 'грузоперевозки', 'курьер', 'logistics', 'delivery', 'shipping', 'перевозки', 'транспорт'],
}

// Activity verbs that indicate business (all forms)
const ACTIVITY_VERBS = [
  'занимаюсь', 'занимается', 'занимаемся',
  'владею', 'владеет', 'владеем',
  'работаю', 'работает', 'работаем',
  'развиваю', 'развивает', 'развиваем',
  'управляю', 'управляет', 'управляем',
  'веду', 'ведёт', 'ведем',
  'открыл', 'открыла', 'открыли', 'открываю',
  'создал', 'создала', 'создали', 'создаю',
  'продаю', 'продаёт', 'продаём', 'продаже', 'продажа', 'продавать',
  'предлагаю', 'предлагает', 'предлагаем',
  'оказываю', 'оказывает', 'оказываем',
  'делаю', 'делает', 'делаем',
  'произвожу', 'производит', 'производим',
  'организую', 'организует', 'организуем',
  'оказываю', 'предоставляю', 'консультирую', 'обучаю', 'помогаю',
  'бизнес', 'компания', 'фирма', 'ип', 'ооо', 'предприятие'
]
