...
export const responses: Record<string, ResponseData> = {
  ...
  price_landing: {
    text: "🔥 **Акция месяца: лендинг под ключ за 600 BYN** вместо 1200 BYN — выгода 50%.\n\nЧто входит:\n- Дизайн под ключ и адаптив под все устройства\n- Тексты и формы заявок\n- SEO-базовая настройка\n- Подключение аналитики\n- Запуск за 5 дней\n\nБез скрытых доплат. Дополнительно: CMS-панель, многоязычность, A/B тестирование.",
    buttons: [
  ...
  price_app: {
    text: "**Веб- или мобильное приложение — от 8000 BYN**\n\nЧто входит:\n- iOS + Android из одной кодовой базы\n- UI/UX дизайн\n- Backend и API\n- Push-уведомления\n- Публикация в сторах\n- 1 месяц поддержки\n\nСроки: от 2 месяцев",
    buttons: [
  ...
  price_design: {
    text: "**UI/UX дизайн**\n\n- Прототип и wireframes\n- Дизайн лендинга\n- Дизайн сайта (5+ стр.)\n- Дизайн-система / UI Kit\n- Редизайн существующего проекта\n\nВсё в Figma с готовыми компонентами для разработки. Точную смету посчитаем под ваш объём на бесплатной консультации.",
    buttons: [
...
export const keywordRules: KeywordRule[] = [
  ...
  { keywords: ["акци", "скидк", "600", "выгод", "лендинг", "landing", "одностраничн"], response: "price_landing" },
