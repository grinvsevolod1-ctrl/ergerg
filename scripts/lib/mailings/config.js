...
exports.mailingConfig = void 0;
exports.validateMailingConfig = validateMailingConfig;
exports.mailingConfig = {
...
// Validation
function validateMailingConfig() {
    const errors = [];
    if (!exports.mailingConfig.smtp.auth.user) {
        errors.push('SMTP_USER is required');
    }
    if (!exports.mailingConfig.smtp.auth.pass) {
        errors.push('SMTP_PASS is required');
    }
    if (!exports.mailingConfig.queue.redis.url) {
